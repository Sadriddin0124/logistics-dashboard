...
//   const { setRuble, setDollar, setTenge, setCurrencyStatus } =
//     useStringContext();

//   return (
//     <div>
//       <button onClick={() => setRuble("75")}>Update Ruble</button>
//       <button onClick={() => setDollar("1.2")}>Update Dollar</button>
//       <button onClick={() => setTenge("470")}>Update Tenge</button>
//       <button onClick={() => setCurrencyStatus((prev) => !prev)}>
