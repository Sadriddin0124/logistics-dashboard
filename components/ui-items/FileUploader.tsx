  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className={`w-full bg-blue-500 flex p-2 cursor-pointer items-center justify-center text-white rounded-md hover:bg-blue-400 ${
      ...
      <div className={image?.file && image?.id ? "" : "hidden"}>
        ...
        ["png", "jpg", "webp"].includes(
          ...
          >
            ...
            />
            <Download
              className="absolute right-12 bottom-2 text-white group-hover:z-[2] z-[-1] text-[24px] cursor-pointer"
              onClick={() =>
                downloadImage(
                  image?.file,
