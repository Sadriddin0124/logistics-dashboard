        ...
        <TableBody>
          {regions?.results?.map((region, index) => (
            <TableRow key={index} className="border-b border-gray-200">
              ...
              <TableCell>{Number((region?.been_driver_expenses as number)?.toFixed(2))?.toLocaleString() || 0} $ </TableCell>
              <TableCell>{Number((region?.gone_driver_expenses as number)?.toFixed(2))?.toLocaleString() || 0} $</TableCell>
              <TableCell>{Number((region?.been_flight_price as number)?.toFixed(2))?.toLocaleString() || 0} $ </TableCell>
              <TableCell>{Number((region?.gone_flight_price as number)?.toFixed(2))?.toLocaleString() || 0} $</TableCell>
